...
public class turret extends MonoBehaviour {
	...
	public static var instance : turret;
	...
	public var _targetLookAt : GameObject; // A variable to hold what enemy the turret is targetting.
	...
	function Start(){
		turretCollider = gameObject.GetComponent(SphereCollider) as SphereCollider;
		_turretInitRotation = transform.rotation;
		
		_rotateSmooth = myInformation.tOneRotateSpeed;
		turretCollider.radius = myInformation.tOneRadius;
		_rayRange = myInformation.tOneRange;
		radiusMesh.transform.localScale = Vector3(myInformation.tOneRadius * 2f, myInformation.tOneRadius * 2f, myInformation.tOneRadius *2f);
