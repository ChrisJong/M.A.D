...
public class fireEarth extends MonoBehaviour {
	
	// Reference.
	public static var instance : fireEarth;
	...
	// Ranges.
	private var _attackRange : float = 5f;
	...
	function Start(){
		...
		// Attack.
		_fireRate = myInformation.eMeleeFireRate;
		_damage = myInformation.eMeleeDamage;
    ...
    function attackTarget(){
    	if(Time.time > _lastFire){
    		...
    		mainPlayerStatus.instance.takeHP(_damage);
    	}
    }
    ...
    function die(){
    	if(_isDead){
    		var randomCash : int = Random.Range(20, 70);
